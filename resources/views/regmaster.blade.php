...
<center>
                      ...
                      <div class="col-sm-4">
                                              ...
                                              <a href="{{ route('register') }}"><img src="pictures/logostartup.jpg" class="img-circle" alt="Cinque Terre" width="304" height="236" href="{{ route('register') }}"></a>
                      ...
                      <div class="col-sm-8">
                                          ...
                                          <a href="{{ route('registers') }}"><img src="pictures/logo.jpg" class="img-circle" alt="Cinque Terre" width="304" height="236" ></a> 

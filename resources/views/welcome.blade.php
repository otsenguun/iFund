...
@include('nav')
  ...
  <div style="position: relative; color: #ffffff; margin-top:50px;min-height: calc( 100% - 50px ); display: flex; align-items: center; background-image: url('pictures/home-slider-03.jpg'); background-size: 100% 100%;">
    <div class="container">
